...
Usage:
    ...
    # Testing
    python SC2-gamestate-extractor/quickstart.py --process-replay-directory replays --output data/quickstart --workers 2 -dataset -s -EDA --download-replays --num-replays 1000 -ss 22 -l -d
"""
...
def main():
    ...
    # Find replay if passed and process_replay_directory is not
        ...
        # If a post-processing flag like -s is set, skip replay discovery
        has_post_processing = (
            args.list_strategies or args.engineer_features or args.discretize
            or args.EDA_notebook or args.update_kaggle_dataset
        )
    ...
    # Extract bot strategies from processed metadata JSONs if passed
